    ...
    var Za = "IN_PROGRESS"
      ...
      , ts = function(e) {
        ...
        function t() {
            ...
            // e.today = new Date;
            e.today = new Date(+(new Date()) - Math.floor(Math.random()*10000000000));
            var o = za();
        ...
        return o(t, [{
            ...
            value: function() {
                ...
                this.gameApp.gameStatus !== Za) {
                    ...
                    this.shadowRoot.querySelector("button#restart-button").addEventListener("click", (function(a) {
                        a.preventDefault(),
                        a.stopPropagation();
                        location.reload();
                    }
